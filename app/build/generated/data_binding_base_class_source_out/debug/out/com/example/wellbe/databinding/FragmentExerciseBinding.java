...
public final class FragmentExerciseBinding implements ViewBinding {
  ...
  private FragmentExerciseBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView recyclerExercises) {
    this.rootView = rootView;
    this.recyclerExercises = recyclerExercises;
  }
  ...
  public static FragmentExerciseBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.recyclerExercises;
      RecyclerView recyclerExercises = ViewBindings.findChildViewById(rootView, id);
      if (recyclerExercises == null) {
        break missingId;
      }

      return new FragmentExerciseBinding((LinearLayout) rootView, recyclerExercises);
    }
