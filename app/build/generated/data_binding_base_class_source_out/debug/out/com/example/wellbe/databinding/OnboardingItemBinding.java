...
public final class OnboardingItemBinding implements ViewBinding {
  ...
  private OnboardingItemBinding(@NonNull LinearLayout rootView, @NonNull ImageView imageOnboarding,
  ...
  public static OnboardingItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new OnboardingItemBinding((LinearLayout) rootView, imageOnboarding, textDescription,
          textTitle);
    }
