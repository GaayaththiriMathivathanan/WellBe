...
public final class ActivityOnboardingBinding implements ViewBinding {
  ...
  private ActivityOnboardingBinding(@NonNull LinearLayout rootView, @NonNull Button btnNext,
      @NonNull Button btnSkip, @NonNull LinearLayout layoutDots, @NonNull ViewPager2 viewPager) {
  ...
  public static ActivityOnboardingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOnboardingBinding((LinearLayout) rootView, btnNext, btnSkip, layoutDots,
          viewPager);
    }
