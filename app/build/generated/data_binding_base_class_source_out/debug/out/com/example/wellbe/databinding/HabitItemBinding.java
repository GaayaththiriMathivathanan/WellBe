...
public final class HabitItemBinding implements ViewBinding {
  ...
  private HabitItemBinding(@NonNull LinearLayout rootView, @NonNull ImageButton btnDelete,
      @NonNull ImageButton btnEdit, @NonNull CheckBox checkHabit, @NonNull TextView textHabitName) {
  ...
  public static HabitItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new HabitItemBinding((LinearLayout) rootView, btnDelete, btnEdit, checkHabit,
          textHabitName);
    }
